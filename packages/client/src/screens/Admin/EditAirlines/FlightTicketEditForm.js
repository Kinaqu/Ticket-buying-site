  ...
  <div style={{
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
      ...
      <div style={{ ...fieldStyle, gridColumn: '1 / -1' }}>
        ...
        <input style={inputStyle} type="text" value={ticket.Plane}
      ...
      <div style={fieldStyle}>
        ...
        <input style={inputStyle} type="text" value={ticket.FlightNumber}
      ...
      <div style={fieldStyle}>
        ...
        <input style={inputStyle} type="datetime-local" value={ticket.LandDateTime}
...
export default FlightTicketEditForm;